" emma.vim - Vim color scheme for 16-color terminals
" --------------------------------------------------------------
" Author:   Emma Eilefsen Glenna (http://eilefsen.no/)
" Version:  1.0.0
" --------------------------------------------------------------
"
" Based on: 
...
hi PmenuKind           ctermfg=NONE  ctermbg=5
hi PmenuExtra          ctermfg=NONE  ctermbg=8     cterm=italic
hi ComplMatchIns       cterm=underdashed
