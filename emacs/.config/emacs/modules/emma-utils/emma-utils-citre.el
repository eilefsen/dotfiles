(use-package citre
  ...
  (keymap-set emma/citre-map "C-x c J" 'citre-jump-back)
  (keymap-set emma/citre-map "C-x c p" 'citre-ace-peek)
  (keymap-set emma/citre-map "C-x c u" 'citre-update-this-tags-file)
  (setq
