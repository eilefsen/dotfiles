...
(defun 2048-mode ()
  ...
  (evil-local-set-key 'normal (kbd "h") '2048-shift-left)
  (evil-local-set-key 'normal (kbd "j") '2048-shift-down)
  (evil-local-set-key 'normal (kbd "k") '2048-shift-up)
  (evil-local-set-key 'normal (kbd "l") '2048-shift-right)
